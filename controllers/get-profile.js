...
const get_profile=(req,res)=>{
    ...
    console.log("in get profile",user_id);
                 ...
                 con.query(`select tweet_id from likes where user_id=${user_id}`,(err,result)=>{
                    ...
                    con.query(`select retweet_id from retweet_likes where user_id=${user_id}`,(err,retweets)=>{
                       const retweets_liked=[];
                             ...
                             general_res({success:true,data_obj:all_records,data_obj2:tweets_liked,data_obj3:retweets_liked,data_obj4:followings,data_obj5:followers},"fetching profile",res)
                       })
                    }
                 })
